...
<div class="container-fluid">
    ...
    <div class="setup-header">
        <div class="x-logo font-16 font-weight-600">CRM - SETUP</div>
    </div>
...
<?php echo $__env->make('layout.wrapperplain', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /www/wwwroot/fernando.sngcr.com/application/resources/views/pages/setup/wrapper.blade.php ENDPATH**/ ?>